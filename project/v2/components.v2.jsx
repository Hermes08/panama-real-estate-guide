// ═══════════════════════════════════════════════════════════════
// v2 Interactive Experience — Panama Real Estate Guide
// Branch: feat/v2-interactive-experience
// Generated: 2026-05-04T15:25:08Z
// ═══════════════════════════════════════════════════════════════
...
function LifestyleQuiz() {
  ...
  const styles = `
    .lifestyle-quiz {
      ...
      margin: 2rem auto;
      padding: 2rem;
      background: var(--cream, #fef9f3);
      border: 1px solid var(--paper, #e8dcc8);
      border-radius: 12px;
    }
    ...
    .option-button {
      padding: 1rem;
      border: 2px solid var(--paper, #e8dcc8);
      background: white;
      border-radius: 8px;
      cursor: pointer;
      font-size: 14px;
    ...
    .option-button:hover {
      border-color: var(--coral, #d4655d);
      background: rgba(212, 101, 93, 0.05);
    }

    .option-button.selected {
      border-color: var(--coral, #d4655d);
      background: var(--coral, #d4655d);
      color: white;
    }
...
function WhatsAppV2() {
  ...
  const wa = (window.PANAMA_DATA && window.PANAMA_DATA.brand && window.PANAMA_DATA.brand.whatsapp) || 'https://wa.me/50762534802';
  const phone = (window.PANAMA_DATA && window.PANAMA_DATA.brand && window.PANAMA_DATA.brand.phone) || '+507 6253-4802';
...
/* ── App.v2 — composition root for the v2 experience ── */
function AppV2() {
  return (
    <>
      ...
      <LifestyleQuiz />
      <PanamaMap />
      {typeof Projects === 'function' && <Projects />}
      <JournalReveal />
      {typeof BookConsultation === 'function' && <BookConsultation />}
