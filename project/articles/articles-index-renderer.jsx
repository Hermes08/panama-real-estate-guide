          ...
          <section style={{ paddingTop: 96, paddingBottom: 32, background: 'var(--cream)' }}>
            <div className="container">
              <div className="reveal" style={{ maxWidth: 720 }}>
                <div className="eyebrow" style={{ color: 'var(--coral-deep)', marginBottom: 16 }}>Journal · {articles.length} articles</div>
                <h1 className="display" style={{ fontSize: 'clamp(40px, 6vw, 72px)', lineHeight: 1.05, margin: '12px 0 24px' }}>
                  Editorial coverage of Panama <em style={{ color: 'var(--coral-deep)', fontStyle: 'italic' }}>real estate, residency, taxes</em> and lifestyle.
                </h1>
                <p style={{ fontSize: 18, color: 'var(--ink-mute)', maxWidth: 60+'ch', lineHeight: 1.55 }}>
                  Long-form articles for international investors, retirees and second-home buyers. Each piece is researched, dated and updated annually.
                </p>
              </div>
                  ...
                  <a key={a.id}
                    ...
                    <div style={{ padding: '24px 24px 28px' }}>
                      ...
                      <p style={{ fontSize: 14, color: 'var(--ink-mute)', lineHeight: 1.5, margin: '0 0 16px' }}>
                        {(a.excerpt || '').substring(0, 160)}{(a.excerpt || '').length > 160 ? '…' : ''}
                      </p>
